...
docker rm -fv srv-web-cusco fw-cusco user1 router-usuario router-central fw-lima srv-mysql-lima srv-ftp-lima cliente1-lima cliente2-lima pebble pebble-challtestsrv 2>/dev/null || true
